...
public class TelaReservaController {
    ...
    public void acaoSolicitarReserva() {
        ...
        // ========================================================
        // 🚀 NOVA ALTERAÇÃO: VALIDAÇÃO DE DATA NO PASSADO
        // ========================================================
        if (dataSel.isBefore(LocalDate.now())) {
            exibirAlerta(Alert.AlertType.ERROR, "Data Inválida", "Não é possível realizar reservas em datas que já passaram!");
            return; // 🛑 Aborta o método aqui, impedindo a criação da reserva
        }
        // ========================================================
